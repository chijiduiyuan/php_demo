...
<head>
  ...
  <link rel="stylesheet" href="/php/6-30/Public/admin/css/style.css">
  <script type="text/javascript" src="/php/6-30/Public/admin/js/jquery.min.js"></script>
  <script type="text/javascript" src="/php/6-30/Public/admin/js/jquery.SuperSlide.js"></script>
      ...
      <div id="top_t">
        ...
        <div id="photo_info" class="fr">
          <div id="photo" class="fl">
            <a href="#"><img src="/php/6-30/Public/admin/images/a.png" alt="" width="60" height="60"></a>
          </div>
