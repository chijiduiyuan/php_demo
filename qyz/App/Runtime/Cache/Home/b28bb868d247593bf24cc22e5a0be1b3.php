...
<style type="text/css">
    .current,.num{width: 50px;height: 30px;line-height: 30px;background: blue;color:#fff;}
        ...
        <div class="scd_m">
        	<ul class="news">
        	  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                	<a href="<?php echo U('News/news_info',array('newsid'=>$val['newsid']));?>">
                    	<p><?php echo ($val["title"]); ?></p>
                        <em><?php echo ($val["sj"]); ?></em>
                    </a>
                </li><?php endforeach; endif; else: echo "" ;endif; ?> 
            </ul>
            <div class="space_hx">&nbsp;</div>
