        ...
        $("#bt").click(function(){
            ...
            if(username==""){alert('请登录');}
                ...
                if(val==""){alert('留言不能为空');}
                    ...
                    $.ajax({
                        url:"<?php echo U('Index/pl_check');?>",
                        type:"POST",
                        dataType:"json",
                        async:true,
                        data:{'message':val},
                        success:function(data){
                            if(data.info){alert(1);}
                        }
                    })
                }
            }
    ...
    <div class="scd_r">
    	<div class="dq">
            ...
            <div class="pst">
                ...
                <span>></span>
                <a href="<?php echo U('Index/message');?>" class="on">客户留言</a>
            </div>
        </div>
        <div class="scd_m">
            <div id="con">
                <img src="/php/thnkphp/Public/Assets/images/g.jpg" />
                <p class="con1">admin<span>shijian</span></p>
                <div class="ptitle">天气不错</div>
            </div>
