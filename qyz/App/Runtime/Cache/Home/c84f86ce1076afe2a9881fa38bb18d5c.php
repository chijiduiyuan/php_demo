...
<title>个人资料</title>
<link rel="stylesheet" type="text/css" href="/php/thnkphp/Public/person/css/style.css" />
<link rel="stylesheet" type="text/css" href="/php/thnkphp/Public/person/css/shopping-mall-index.css" />
<script type="text/javascript" src="/php/thnkphp/Public/person/js/jquery.js"></script>
<script type="text/javascript" src="/php/thnkphp/Public/person/js/zhonglin.js"></script>
</head>
    	...
    	<div class="top-con w1200">
            ...
            <ul class="t-con-r f-r">
            	...
            	<li class="erweima">
                	<a href="#">扫描二维码</a>
                    <div class="ewm-tu">
                    	<a href="#"><img src="/php/thnkphp/Public/person/images/erweima-tu.jpg" /></a>
                    </div>
                </li>
    ...
    <div class="personal w1200">
    	...
    	<div class="personal-r f-r">
        	<div class="personal-right">
                ...
                <form method="post" action="<?php echo U('Login/person_check');?>" enctype="multipart/form-data">
                <div class="data-con">
                	<div class="dt1">
                    	<p class="f-l">当前头像：</p>
                        <div class="touxiang f-l">
                        	<div class="tu f-l">
                            	<a href="#">
                                	<img src="/php/thnkphp/Uploads/<?php echo (session('pic')); ?>" />
