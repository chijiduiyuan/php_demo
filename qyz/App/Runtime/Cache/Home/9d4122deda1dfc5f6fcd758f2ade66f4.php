    ...
    <div class="scd_r">
    	<div class="dq">
            ...
            <div class="pst">
                ...
                <span>></span>
                <a href="<?php echo U('Index/contact');?>" class="on">联系诺博源</a>
            </div>
        </div>
        <div class="scd_m">
        	<div class="contact">
            	<dl class="clearfix">
                	<dt><img src="/php/thnkphp/Public/Assets/images/pic4.png" alt=""/></dt>
                    <dd>
                    	<?php echo (htmlspecialchars_decode($list['content'] )); ?>
                    </dd>
                </dl>
                <div class="space_hx">&nbsp;</div>
                <div class="map"><img src="/php/thnkphp/Public/Assets/upload/pic13.jpg" alt=""/></div>
            </div>
        </div>
    </div>
</div>
