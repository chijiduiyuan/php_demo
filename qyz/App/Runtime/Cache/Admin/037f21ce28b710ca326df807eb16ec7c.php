...
<head>
	<meta charset="UTF-8">
    <link rel="stylesheet" href="/qyz/Public/Admin/css/login.css">
	<title>后台登陆</title>
	<script type="text/javascript" src="/qyz/Public/admin/js/jquery.min.js">  
    </script>
    <script>
	    $(function(){
			 $(".username").keyup(function(){
				   var val=$(this).val();
				   $.ajax({
					     url:"<?php echo U('Index/username_ajax');?>",
						 type:"POST",
						 dataType:"json",
						 async:true,
						 data:{'username':val},
		...
		<div id="login_area">
			<div id="login_form">
				<form action="<?php echo U('Index/login_check');?>" method="post">
            		...
            		<div id="notice_username" style="color:red"></div>
