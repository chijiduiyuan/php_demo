<?php if (!defined('THINK_PATH')) exit();?> <!doctype html>
 ...
 <head>
   ...
   <script type="text/javascript" src="/qyz/Public/Admin/js/colResizable-1.3.min.js"></script>
   <script type="text/javascript" src="/qyz/Public/Admin/js/common.js"></script>
 ...
 <body>
    ...
    <select id="search" style="border:#999 1px solid;">
       ...
       <?php if(is_array($cp_type)): $i = 0; $__LIST__ = $cp_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["typeid"]); ?>" ><?php echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
     ...
     <ul class="cp">
       ...
       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              <img src="/qyz/Uploads/<?php echo ($vo["cppic"]); ?>" width="200" height="150" />
              <p class="title"><?php echo ($vo["cpname"]); ?></p>
              <p class="editor"> <a href="javasript:void(0)">编辑</a> | <a href="javasript:void(0)">删除</a></p>
