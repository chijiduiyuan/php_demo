          ...
          <div class="pay-info">
            ...
            <ul class="pay-yh">
              <li>
                ...
                <img src="/dshop/Public/Home/pic/zfb.jpg" width="99" height="41"  style="margin-top:20px;" />
                <div style="clear:both;"></div>
              </li>
              <li>
                <input type="radio" value="" name="hobby" class="sex" />
             
                <img src="/dshop/Public/Home/pic/timg.jpg" width="99" height="41"  style="margin-top:20px;" />
                <div style="clear:both;"></div>
              </li>
