    ...
    <div class="personal w1200">
    	...
    	<div class="order-right f-r">
        	<div class="order-hd">
            	<dl class="f-l">
                	<dt>
                    	<a href="#"><img src="/dshop/Public/Home/images/data-tu2.gif" /></a>
                    </dt>
                    <dd>
                    	<h3><a href="#">RH了</a></h3>
                        <p>zhao601884596</p>
            ...
            <!--  第一层循环   -->    
             <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="md-info">
              <div class="md-tit" style="border-bottom:0px; border-top:#CCC 1px solid; position:relative;">
               ...
               <a href="#" style="position:absolute; display:inline-block; top:13px; right:10px;  width:18px; height:17px;background:url(/dshop/Public/home/images/del.png) no-repeat -239px -176px; " title="删除"></a>
                </div>
                ...
                <div class="dai-con">
                  ...
                  <?php if(is_array($vo['son'])): $i = 0; $__LIST__ = $vo['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cp_vo): $mod = ($i % 2 );++$i;?><tr  height="90">
                     ...
                     <td width="103">  
                                <a href="#" class="f-l"><img src="/dshop/Uploads/<?php echo ($cp_vo["img"]); ?>" width="80" height="80" /></a></td>
        ...
        <div class="view-con">
        	<div class="view-tit">
                ...
                <a href="JavaScript:;" guanbi="">
                	<img src="/dshop/Public/Home/images/close-select-city.gif" />
                </a>
                <div style="clear:both;"></div>
            </div>
            <div class="view-bd">
