        ...
        <div class="cart-con-info">
         ...
         <?php if(is_array($cplist)): $i = 0; $__LIST__ = $cplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cpvo): $mod = ($i % 2 );++$i;?><div class="info-mid">
                <div class="mid-tu f-l">
                	<a href="#"><img src="/dshop/Uploads/<?php echo ($cpvo["spic"]); ?>" width="80" height="80" /></a>
                </div>
 ...
 <!--留言板块--><!--底部服务-->
    ...
    <div class="confirmation-tanchuang" id="new_addr" xgdz1="">
    	...
    	<div class="tanchuang-con">
        	<div class="tc-title">
            	<h3>新增地址</h3>
                <a href="JavaScript:;" dz-guan=""><img src="/dshop/Public/Home/images/close-select-city.gif" /></a>
                <div style="clear:both;"></div>
            </div>
            <ul class="tc-con2">
            	<li class="tc-li1">
