...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     <form method="post" action="<?php echo U('Cp/cp_modi_check');?>"  enctype="multipart/form-data">
    <ul class="forminfo">
    <li>
      <label>产品标题</label><input name="cpname" type="text" class="dfinput" value="<?php echo ($cplist["cpname"]); ?>" /><i>标题不能超过30个字符</i></li>
      <input type="hidden" name="cpid" value="<?php echo ($cplist["cpid"]); ?>" />
      <li><label>产品分类</label>
...
<!-- <li><label>是否推荐</label><cite><input name="tj" type="radio" value="1"  />是&nbsp;&nbsp;&nbsp;&nbsp;<input name="tj" type="radio" value="0" checked="checked" />否</cite></li> -->
    ...
    <input type="hidden" name="cppic" value="<?php echo ($cplist["cppic"]); ?>" />
    <input type="hidden" name="spic" value="<?php echo ($cplist["spic"]); ?>" />
    </li>
     
    </li>   
    
    
   <li><label>产品价格</label><input name="price" value="<?php echo ($cplist["price"]); ?>" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>

    <li><label>产品简单说明</label>
    <textarea name="con" class="dfinput" style="height: 100px;" ><?php echo ($cplist["con"]); ?></textarea>

    </li>


    <li><label>产品详情</label>
    <textarea name="content" id="container" style="width:800px; height:400px" ><?php echo ($cplist["content"]); ?></textarea>
